...
class LocalString {
  ...
  static LocalString of(BuildContext context) {
    ...
    assert(instance != null, 'No instance of LocalString present in the widget tree. Did you add LocalString.delegate in localizationsDelegates?');
    return instance!;
  }
  ...
  String get authentication_failure {
    return Intl.message('Authentication Failure', name: 'authentication_failure', desc: '', args: []);
  }

  /// `Server Error`
  String get server_error {
    return Intl.message('Server Error', name: 'server_error', desc: '', args: []);
  }
}
